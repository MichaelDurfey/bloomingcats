...
//   const { } = styles;
  ...
  function audioPlay() {
    return (
      <svg onClick={() => togglePlay()} width="1.5em" height="1.5em" viewBox="0 0 16 16" className="bi bi-volume-up" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  function audioOff() {
    return (
      <svg onClick={() => togglePlay()} width="1.5em" height="1.5em" viewBox="0 0 16 16" className="bi bi-volume-off" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
